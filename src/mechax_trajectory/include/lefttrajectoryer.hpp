...
public:
    ...
    void lefttarget_callback(const auto_aim_interfaces::msg::Target msg);

    void leftangle_callback(const auto_aim_interfaces::msg::ReceiveSerial msg);
    ...
    // Subsciption
    //------------------
    rclcpp::Subscription<auto_aim_interfaces::msg::Target>::SharedPtr lefttarget_sub_;
    rclcpp::Subscription<auto_aim_interfaces::msg::ReceiveSerial>::SharedPtr leftangle_sub_;
    //------------------
    // Publisher
    //------------------
    rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr leftmaker_pub_;
    rclcpp::Publisher<auto_aim_interfaces::msg::SendSerial>::SharedPtr result_pub_;
    rclcpp::Publisher<geometry_msgs::msg::PointStamped>::SharedPtr leftneedpose_pub_;
    //------------------
    //timer
    //------------------
