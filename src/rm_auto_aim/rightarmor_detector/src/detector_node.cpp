...
namespace rightrm_auto_aim
{
ArmorDetectorNode::ArmorDetectorNode(const rclcpp::NodeOptions & options)
: Node("rightarmor_detector", options)
{
  ...
  armors_pub_ = this->create_publisher<auto_aim_interfaces::msg::Armors>(
    "/rightdetector/armors", rclcpp::SensorDataQoS());
  ...
  marker_pub_ =
    this->create_publisher<visualization_msgs::msg::MarkerArray>("/rightdetector/marker", 10);
  ...
  cam_info_sub_ = this->create_subscription<sensor_msgs::msg::CameraInfo>(
    ...
    "/rightcamera_info", rclcpp::SensorDataQoS(),
  ...
  needpose_sub_ = this->create_subscription<geometry_msgs::msg::PoseStamped>("/righttracker/needpose", 10,
...
std::unique_ptr<Detector> ArmorDetectorNode::initDetector()
{
  ...
  // Init classifier
  auto pkg_path = ament_index_cpp::get_package_share_directory("rightarmor_detector");
...
{
  lights_data_pub_ =
    this->create_publisher<auto_aim_interfaces::msg::DebugLights>("/rightdetector/debug_lights", 10);
  armors_data_pub_ =
    this->create_publisher<auto_aim_interfaces::msg::DebugArmors>("/rightdetector/debug_armors", 10);

  binary_img_pub_ = image_transport::create_publisher(this, "/rightdetector/binary_img");
  number_img_pub_ = image_transport::create_publisher(this, "/rightdetector/number_img");
  result_img_pub_ = image_transport::create_publisher(this, "/rightdetector/result_img");
}
...
RCLCPP_COMPONENTS_REGISTER_NODE(rightrm_auto_aim::ArmorDetectorNode)
